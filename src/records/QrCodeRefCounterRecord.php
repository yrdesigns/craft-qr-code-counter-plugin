...
namespace yrdesignscraftqrcodecounter\qrcoderefcounter\records;
 ...
 * @since     1.0.0
 */
class QrCodeRefCounterRecord extends ActiveRecord
{
    ...
    {
        return '{{%qrcoderefcounter_qrcoderefcounterrecord}}';
    }
}
