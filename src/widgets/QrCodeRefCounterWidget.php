...
namespace yrdesignscraftqrcodecounter\qrcoderefcounter\widgets;

use yrdesignscraftqrcodecounter\qrcoderefcounter\QrCodeRefCounter;
use yrdesignscraftqrcodecounter\qrcoderefcounter\assetbundles\qrcoderefcounterwidgetwidget\QrCodeRefCounterWidgetWidgetAsset;

use Craft;
use craft\base\Widget;

/**
 * QR Code ref counter Widget
 *
 ...
 * @since     1.0.0
 */
class QrCodeRefCounterWidget extends Widget
{
    ...
    public function getSettingsHtml()
    {
        return Craft::$app->getView()->renderTemplate(
            'qr-code-ref-counter/_components/widgets/QrCodeRefCounterWidget_settings',
            [
                'widget' => $this
            ]
        );
    ...
    {
        Craft::$app->getView()->registerAssetBundle(QrCodeRefCounterWidgetWidgetAsset::class);
